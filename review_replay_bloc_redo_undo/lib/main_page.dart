...
import 'package:review_replay_bloc_redo_undo/bloc/counterb_bloc.dart';
import 'package:review_replay_bloc_redo_undo/cubit/counterc_cubit.dart';
                ...
                children: [
                  ...
                  BlocBuilder<CounterbBloc, CounterbState>(
                    builder: (_, state) => Text(
                        (state is InitializebCounter) ? '${state.number}' : '-',
                        style: GoogleFonts.poppins(
                            fontSize: 35,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      //// BLOC INCREMENT
                      context.read<CounterbBloc>().add(AddInst());
                    },
                    child: Text("+",
                        style: GoogleFonts.poppins(
